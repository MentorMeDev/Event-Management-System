...
function Users() {
  const initialUsers = [
    ...
    },
    {
      id:5,
      name: "Musau Marylyne",
      email: "marylynemutindi@gmail.com",
      role: "User",
      status: "Active",
    },
  ];
      ...
      <Modal isOpen={isAddUserOpen} title="Add User" onClose={() => setIsAddUserOpen(false)}>
        <form onSubmit={handleAddUser} className="space-y-4">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button type="submit" color="green" className="rounded-2xl bg-cyan-400/20 px-4 py-2 font-semibold text-cyan-300 hover:bg-cyan-400/30">
              Add User
            </button>
          </div>
        </form>
