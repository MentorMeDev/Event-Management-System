...
function AdminLayout({ title = "Admin Panel", children }) {
  const menuItems = [
    ...
    { label: "Organisations", path: "/admin/organisations", icon: Building2 },
    { label: "Attendees", path: "/admin/attendees", icon: UserRound },
    { label: "Events", path: "/admin/events", icon: CalendarDays },
    { label: "Registrations", path: "/admin/registrations", icon: ClipboardList },
    { label: "Reports", path: "/admin/reports", icon: BarChart3 },
    { label: "Recent Activities", path: "/admin/recent-activities", icon: Activity },
  ];
